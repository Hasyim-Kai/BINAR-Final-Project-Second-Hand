...
export default function ProductItem({ id = 0, name = 'null', img = "/images/cat.jpg", category = 'null', price = 0, isMine = false }) {
   return <Link to={isMine ? '/my-product/1' : '/product/1'}><div className="p-2 border-2 border-gray-100 rounded-md w-44 md:w-52 hover:shadow-lg hover:shadow-purple-100 transition-all duration-300">
